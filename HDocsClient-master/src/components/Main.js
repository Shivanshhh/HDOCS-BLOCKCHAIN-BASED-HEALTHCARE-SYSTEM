      ...
      <div className="row main-main">
        <div className="content" style={{ marginBottom: "50px" }}>
          <div className="left">
            ...
            >
              {
                user.email !== "strtiwari28@gmail.com" ?
                  (
                    ...
                    <ul id="imageList" className="list-group list-group-flush">
                      <li className="list-group-item">
                        <div className="text-center">
                          <iframe
                            ...
                            src={`https://hdocss.infura-ipfs.io/ipfs/${image.report}`}
                            controls
                            style={{ width: '400px' }}
                          ></iframe>
                        </div>
                      ...
                      <li key={key} className="list-group-item py-2">
                        ...
                        <div style={{ float: "right" }} className="tip-enter-div">
                          ...
                          <a href={`https://hdocss.infura-ipfs.io/ipfs/${image.report}`} target="_blank" rel="noopener noreferrer">VIEW</a><br />
                        </div>
                      </li>
                    </ul>
                  </Card>
